...
class VendasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create venda" do
    assert_difference("Venda.count") do
      post vendas_url, params: { venda: { data: @venda.data, medicamento_id: @venda.medicamento_id, quantidade: @venda.quantidade } }
    end
  ...
  test "should update venda" do
    patch venda_url(@venda), params: { venda: { data: @venda.data, medicamento_id: @venda.medicamento_id, quantidade: @venda.quantidade } }
