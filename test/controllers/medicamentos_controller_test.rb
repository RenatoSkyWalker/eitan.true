...
class MedicamentosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create medicamento" do
    assert_difference("Medicamento.count") do
      post medicamentos_url, params: { medicamento: { descrição: @medicamento.descrição, nome: @medicamento.nome, valor: @medicamento.valor } }
    end
  ...
  test "should update medicamento" do
    patch medicamento_url(@medicamento), params: { medicamento: { descrição: @medicamento.descrição, nome: @medicamento.nome, valor: @medicamento.valor } }
