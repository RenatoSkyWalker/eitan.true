class AtendentesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @atendente.save
        format.html { redirect_to atendente_url(@atendente), notice: "Um atenden foi registrado." }
  ...
  def update
    respond_to do |format|
      if @atendente.update(atendente_params)
        format.html { redirect_to atendente_url(@atendente), notice: "Atendente foi atualizado." }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to atendentes_url, notice: "Atendente foi excluído com êxito." }
  ...
  private
    ...
    def atendente_params
      params.require(:atendente).permit(:usuário)
    end
end
