class VendasController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @venda.save
        format.html { redirect_to venda_url(@venda), notice: "Venda registrada." }
  ...
  def update
    respond_to do |format|
      if @venda.update(venda_params)
        format.html { redirect_to venda_url(@venda), notice: "Venda Atualizada." }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to vendas_url, notice: "Venda Excluída." }
  ...
  private
    ...
    def venda_params
      params.require(:venda).permit(:quantidade, :data, :medicamento_id)
    end
end
